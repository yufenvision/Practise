...
public class TestDemo1 { 
  public static void main(String[] args){ 
    ...
    System.setProperty("webdriver.geko.driver","D:/Drivers/geckodriver.exe"); S
    ystem.out.println("loadGeckodriverSuccessfully!"); 
    WebDriver driver= new FirefoxDriver(); 
    driver.get("http://student.uestcedu.com/console/main.html"); 
    WebElement searchBox=driver.findElement(By.id("item_logout")); 
    searchBox.click(); delay(2); 
    ...
    driver.findElement(By.id("login_button")).click(); delay(2); 
    ...
    /* WebElement ele=null;
    //通过查看是否完全抓取不到该页面此内容，还是应为浏览器刷新的缘故 
    while(ele==null){ 
      try { ele= driver.findElement(By.xpath("//[@id='tr_tblDataList_6']/td[8]/a[1]")); 
